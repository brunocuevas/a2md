...
DATA_FOLDER = r'C:\Users\Bruno\ownCloud\main\a2mdnet\data\aromatic/'
...
if __name__ == '__main__':
    ...
    feats_t = np.load(DATA_FOLDER + 'set_aromatic_training.sym.npy')
    feats_v = np.load(DATA_FOLDER + 'set_aromatic_validation.sym.npy')
    labels_t = np.load(DATA_FOLDER + 'set_aromatic_training.lab.npy')
    labels_v = np.load(DATA_FOLDER + 'set_aromatic_validation.lab.npy')
    targets_t = np.load(DATA_FOLDER + 'set_aromatic_training.ppp.npy')
    targets_v = np.load(DATA_FOLDER + 'set_aromatic_validation.ppp.npy')
    ...
    hist_b, hist = na2mdnn.train(epochs=10, subnet_epochs=10)
    ...
    na2mdnn.validate(save_output_filename=MODEL_FOLDER + 'naive_a2mdnet_validation_2.csv')
    na2mdnn.save_model(save_model_filename=MODEL_FOLDER + 'naive_a2mdnet_2')
