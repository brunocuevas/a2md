import json
import os
MAX_NUMBER_EVAL_POINTS = 100
LIBRARY_PATH = os.path.dirname(os.path.abspath(__file__))
AEV_PARAMETERS = LIBRARY_PATH + '/params/aev_params.params'
with open(LIBRARY_PATH + '/params/symmetry_functions_parameters.json') as f:
    SYMMETRY_PARAMETERS = json.load(f)
N_RADIAL_FEATS = len(SYMMETRY_PARAMETERS['radial'])
N_ANGULAR_FEATS = len(SYMMETRY_PARAMETERS['angular'])
